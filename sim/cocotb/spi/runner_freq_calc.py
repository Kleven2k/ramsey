...
SOURCES = [
    REPO_ROOT / "rtl" / "spi" / "freq_calc.sv",
    SIM_DIR   / "freq_calc_tb_wrapper.sv",
]

SIM_BUILD = SIM_DIR / "sim_build_spi"
VVP_FILE  = SIM_BUILD / "sim_freq_calc.vpp"
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_freq_calc"
