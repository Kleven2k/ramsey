...
SOURCES = [
    REPO_ROOT / "rtl" / "counter"     / "photon_counter.sv",
    REPO_ROOT / "rtl" / "sequencer"   / "pulse_sequencer.sv",
    REPO_ROOT / "rtl" / "accumulator" / "shot_accumulator.sv",
    SIM_DIR   / "integration_tb_wrapper.sv",
]

SIM_BUILD = SIM_DIR / "sim_build_integration"
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_integration"
