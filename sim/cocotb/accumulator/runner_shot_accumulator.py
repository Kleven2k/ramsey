...
SOURCES = [
    ...
    SIM_DIR   / "shot_accumulator_tb_wrapper.sv",
]

SIM_BUILD = SIM_DIR / "sim_build_accumulator"
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_shot_accumulator"
