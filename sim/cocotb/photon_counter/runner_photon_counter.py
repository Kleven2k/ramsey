...
RTL_PH_CNT = REPO_ROOT / "rtl" / "counter"

SOURCES = [
    REPO_ROOT / "rtl" / "counter" / "photon_counter.sv",
    SIM_DIR / "photon_counter_tb_wrapper.sv",
]

SIM_BUILD = SIM_DIR / "sim_build_photon_counter"
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_photon_counter"
