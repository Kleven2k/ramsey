...
## Buttons
#set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS33 } [get_ports { btn_start }]; #IO_L20N_T3_16 Sch=btnc
#set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS33 } [get_ports { btn_delay_down }]; #IO_L22N_T3_16 Sch=btnd
#set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS33 } [get_ports { btn_dwell_delay_down }]; #IO_L20P_T3_16 Sch=btnl
#set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33 } [get_ports { btn_dwell_delay_up }]; #IO_L6P_T0_16 Sch=btnr
#set_property -dict { PACKAGE_PIN F15 IOSTANDARD LVCMOS33 } [get_ports { btn_delay_up }]; #IO_0_16 Sch=btnu
...
## UART
set_property -dict { PACKAGE_PIN AA19  IOSTANDARD LVCMOS33 } [get_ports { uart_tx_pin }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { uart_rx_pin }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=uart_rx_out
...
set_property -dict { PACKAGE_PIN Y6   IOSTANDARD LVCMOS33 } [get_ports { spi_clk    }]; #JC pin 1
set_property -dict { PACKAGE_PIN AA6  IOSTANDARD LVCMOS33 } [get_ports { spi_mosi   }]; #JC pin 2
set_property -dict { PACKAGE_PIN AA8  IOSTANDARD LVCMOS33 } [get_ports { spi_le     }]; #JC pin 3
set_property -dict { PACKAGE_PIN AB8  IOSTANDARD LVCMOS33 } [get_ports { lock_detect}]; #JC pin 4  (input from ADF4351 LD)
